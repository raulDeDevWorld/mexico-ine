...
function Home({ children }) {
  ...
  return (
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className={`fixed top-0 w-[220px] lg:w-[280px]   h-screen bg-white h-screen transition-all	z-40  ${nav ? 'left-0  ' : 'left-[-220px] lg:left-[-280px] '} z-50`} >
        <div class="py-4">
          <Navbar rol={'Cliente'} />
        </div>
      </div>
      ...
      <main className={`relative min-w-screen pt-[85px] pb-[65px] lg:pb-0  lg:min-w-auto my-[0px] overflow-x-hidden lg:bg-gray-100 lg:min-h-screen md:pt-[85px] ${nav ? 'w-screen pl-[220px] lg:pl-[280px]  ' : '  lg:px-[0px]'}`} onClick={() => setNav(false)} style={{ transition: 'all 0.5' }}>
        <nav className="w-screen fixed top-0 border-b border-gray-200 shadow-sm flex flex-col items-center justify-between bg-[#B70073]  p-4 h-auto z-30" onClick={() => setNav(false)}>

          <div className='w-full grid grid-cols-4 gap-x-4 place-items-center py-4 ' style={{ gridTemplateColumns: '150px 2fr 430px' }}>
            ...
            <div className='flex '>
              ...
              <img src="/logo-ine 1.png" className='h-[50px]' alt="" />
            </div>
            <div className="relative w-[80%]">
              <div className="absolute inset-y-0 right-[5px] flex items-center py-3 pointer-events-none">
                <svg className="w-8 h-8 text-white " aria-hidden="true" fill="#000000" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill="#000000e4" d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z" clipRule="evenodd"></path></svg>
                <span className="sr-only">Search icon</span>
              </div>
              <input type="text" id="search-navbar" onChange={handlerFilter} className="block w-full bg-white rounded-full  p-2 pl-10 text-[16px] text-gray-950 text-left border-b border-gray-300  bg-transparent focus:ring-white focus:border-white focus:outline-transparent" placeholder="Buscar..." />
            </div>
          ...
          <div className='w-[800px] grid grid-cols-6 gap-x-4 py-4'>
        ...
        <div className="lg:px-[50px] pt-[150px] w-screen">
