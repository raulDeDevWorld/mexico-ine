...
function Home() {
    ...
    const data = [
        {
            title: 'Artículo 54 de la LEGIPE',
    ...
    return (
        ...
        <main className="p-5">
            ...
            <h3 className='flex items-center font-bold'> <span className='inline-block bg-[#B70073] h-[30px] w-[30px] mr-5 rounded-full'></span>Dirección Ejecutiva Del Registro Federal de Electores</h3>
            <Section data={data} />
