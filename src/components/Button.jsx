...
export default function Button({ theme, styled, click, children }) {
    ...
    switch (theme) {
        case 'Transparent':
            return <button
                type="submit"
                className="text-black bg-transparent border-[2px] border-gray-300 hover:bg-white hover:text-gray-900 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium hover:font-normal rounded-full text-[18px] w-full max-w-[150px] mr-5 px-2 py-2 text-center z-20"
        ...
        case 'Primary':
            return <button
                type="submit"
                className="relative text-white bg-[#000000] border border-gray-100 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-[16px] w-full max-w-[200px] px-2 py-2 text-center z-20"
                // className="text-white bg-violet-700 hover:bg-violet-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center 
                // dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                onClick={click}
            >
        ...
        case 'Secondary':
            return <button
                type="submit"
                className="relative text-black bg-white hover:bg-violet-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-[14px] w-full max-w-[200px] px-2 py-2 text-center z-20"
                // className="text-white bg-violet-700 hover:bg-violet-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center 
                // dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                onClick={click}
            >
        ...
        case 'MiniPrimary':
            return <button
                type="submit"
                className="relative text-white bg-[#000000] border border-gray-100 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-bold rounded-full text-[16px] w-full px-6 py-2  text-center font-medium z-20"
                // className="text-white bg-violet-700 hover:bg-violet-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center 
                // dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                onClick={click}
            >
